...
DESKTOPCODE='../../../application/client/desktop/demo_2965'
DESKTOPIMAGENAME='geppettotest/demo_2965-desktop:1.0'
...
helm install --name demo_2965 ./helm
if [ $? -eq 0 ]; then
